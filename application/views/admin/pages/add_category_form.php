...
<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						...
						<?php echo form_open('category/save_category', 'class=form-horizontal');?>
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" name="category_short_desc" class="span6 typeahead"  id="typeahead"  data-provide="typeahead" data-items="4" required>
							  </div>
							</div>
