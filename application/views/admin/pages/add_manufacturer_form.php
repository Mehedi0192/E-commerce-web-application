						...
						<?php echo form_open('manufacturer/save_manufacturer', 'class=form-horizontal'); ?>
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" name="manufacturer_short_desc" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" required>
							  </div>
							</div>
							...
							<div class="control-group hidden-phone">
							  ...
							  <div class="controls">
								<textarea class="cleditor" name="manufacturer_long_desc" id="textarea2" rows="3"></textarea>
							  </div>
							</div>
