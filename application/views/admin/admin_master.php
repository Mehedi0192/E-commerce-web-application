...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Eshoppers Admin Panel</title>
...
<body>
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="<?php echo base_url()?>"><span>Eshoppers</span></a>
					...
					<ul class="nav pull-right">
						...
						<li class="dropdown">
							<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
								...
								<?php echo $this->session->user_email;?>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a href="<?php base_url()?>admin-dashboard"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Dashboard</span></a></li>	

						<li><a href="<?php base_url()?>register-admin"><i class="icon-envelope"></i><span class="hidden-tablet">Register Admin</span></a></li>

						<li><a href="<?php echo base_url()?>add-category"><i class="icon-tasks"></i><span class="hidden-tablet"> Add Category</span></a></li>

						<li><a href="<?php echo base_url()?>manage-category"><i class="icon-eye-open"></i><span class="hidden-tablet">Manage Category</span></a></li>

						<li><a href="<?php echo base_url()?>add-manufacturer"><i class="icon-list-alt"></i><span class="hidden-tablet"> Add Manufacturer</span></a></li>

						<li><a href="<?php echo base_url()?>manage-manufacturer"><i class="icon-font"></i><span class="hidden-tablet"> Manage Manufacturer</span></a></li>

						<li><a href="<?php echo base_url()?>add-product"><i class="icon-dashboard"></i><span class="hidden-tablet"> Add Product</span></a></li>
						
						<li><a href="<?php base_url('')?>manage-product"><i class="icon-edit"></i><span class="hidden-tablet"> Manage Product</span></a></li>


						<li><a href="gallery.html"><i class="icon-picture"></i><span class="hidden-tablet"> Total Order</span></a></li>
	...
	<footer>
		...
		<p>
			<span style="text-align:left;float:left">&copy; 2018 <a href="<?php echo base_url()?>" alt="Bootstrap_Metro_Dashboard">Eshoppers Admin Panel</a></span>
